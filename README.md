...
**[Download ClawDoc 0.3.3 for macOS (Universal: Apple Silicon + Intel)](https://github.com/ntelioai/ClawDoc/releases/download/v0.3.3/ClawDoc-0.3.3-universal.dmg)** · 230 MB  
**[Download ClawDoc 0.3.3 for Windows (x64)](https://github.com/ntelioai/ClawDoc/releases/download/v0.3.3/ClawDoc-0.3.3.Setup.exe)** · 163 MB

**Linux:** [`.deb`](https://github.com/ntelioai/ClawDoc/releases/download/v0.3.3/clawdoc_0.3.3_amd64.deb) (x64, 105 MB) · [`.rpm`](https://github.com/ntelioai/ClawDoc/releases/download/v0.3.3/clawdoc-0.3.3-1.x86_64.rpm) (x64, 109 MB)
