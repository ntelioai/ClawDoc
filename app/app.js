...
(function () {
  ...
  const TEXT_EXTS = ['txt','text','csv','tsv','json','jsonc','yaml','yml','xml',
  ...
  // Render kind for a doc. Prefer the indexer's `kind`; fall back to ext so
  // older index.json files (pre-reindex) still render sensibly.
